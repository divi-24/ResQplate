      ...
      >
        ...
        <div className="relative text-center text-white px-4 max-w-4xl mx-auto">
          <h1 className="text-6xl font-bold mb-6 leading-tight">
            Make a Difference,
            <span className="block text-#f8a723-400">One Meal at a Time</span>
          </h1>
          ...
          <a 
            href="#donate-form"
            className="bg-#f8a723-600 hover:bg-#f8a723-500 text-white font-bold py-4 px-10 rounded-full text-lg transition duration-300 transform hover:scale-105 hover:shadow-lg inline-flex items-center space-x-2"
          >
      ...
      <div className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-20 text-gray-800">
            How It <span className="text-#f8a723-600">Works</span>
          </h2>
          <div className="grid md:grid-cols-4 gap-8 relative">
            {[
              ...
              >
                <div className={`bg-#f8a723-100 w-28 h-28 rounded-full flex items-center justify-center mx-auto mb-6 text-#f8a723-600 transform transition-all duration-300 ${
                  activeStep === index ? 'bg-#f8a723-600 text-white scale-110' : ''
                }`}>
                  {step.icon}
                </div>
                ...
                {index < 3 && (
                  <div className="hidden md:block absolute top-1/2 left-0 w-full" style={{ transform: 'translateY(-50%)' }}>
                    <div className="border-t-2 border-#f8a723-200 w-full" style={{ margin: '0 15%' }}></div>
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative group">
                      <select 
                        className="w-full p-4 border-2 border-gray-200 rounded-xl appearance-none focus:outline-none focus:border-#f8a723-500 transition-all duration-300 bg-gray-50 group-hover:border-#f8a723-300"
                      ...
                      <ChevronDown className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-#f8a723-500 transition-colors duration-300" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input 
                      type="number"
                      className="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-#f8a723-500 transition-all duration-300 bg-gray-50 hover:border-#f8a723-300"
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative group">
                      <MapPin className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-#f8a723-500 transition-colors duration-300" />
                      <input 
                        type="text"
                        className="w-full p-4 pl-12 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-#f8a723-500 transition-all duration-300 bg-gray-50 group-hover:border-#f8a723-300"
                  ...
                  <div>
                    ...
                    <textarea 
                      className="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-#f8a723-500 transition-all duration-300 bg-gray-50 hover:border-#f8a723-300 h-[104px] resize-none"
              ...
              <div className="pt-6">
                <button 
                  type="submit"
                  className="w-full bg-#f8a723-600 hover:bg-#f8a723-500 text-white font-bold py-4 px-8 rounded-xl transition duration-300 transform hover:scale-[1.02] hover:shadow-lg flex items-center justify-center space-x-2 text-lg"
                >
