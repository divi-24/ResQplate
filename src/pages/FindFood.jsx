...
export default function FindFood() {
  ...
  const foodItems = [
    ...
    },
    {
      ...
      rating: 4.9,
      phone: "(555) 456-7890",
      email: "orangegarden@example.com",
          ...
          <div className="grid md:grid-cols-4 gap-12">
            {[
              ...
              <div key={index} className="text-center group cursor-pointer">
                <div className="w-20 h-20 mx-auto mb-6 bg-orange-100 rounded-2xl flex items-center justify-center transform transition-transform group-hover:scale-110 group-hover:bg-orange-200">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                value={location}
            ...
            <div className="relative">
              ...
              <select
                className="w-full pl-12 pr-4 py-3 border-2 rounded-xl appearance-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                value={category}
            ...
            <button className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-xl font-semibold transition-colors text-lg">
              Search Food
            </button>
          </div>
        </div>
              ...
              <div className="flex">
                ...
                <div className="w-3/5 p-6">
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors">
                      Request Food
                    </button>
