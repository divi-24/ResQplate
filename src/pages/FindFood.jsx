...
export default function FindFood() {
  ...
  const foodItems = [
    ...
    },
    {
      ...
      rating: 4.9,
      phone: "(555) 456-7890",
      email: "#f8a723garden@example.com",
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-2xl">
            ...
            <div className="flex gap-4">
              <button className="bg-#f8a723-600 hover:bg-#f8a723-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors">
                Request Food
              </button>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            {[
              ...
              <div key={index} className="text-center group cursor-pointer">
                <div className="w-20 h-20 mx-auto mb-6 bg-#f8a723-100 rounded-2xl flex items-center justify-center transform transition-transform group-hover:scale-110 group-hover:bg-#f8a723-200">
                  <step.icon className="w-10 h-10 text-#f8a723-600" />
                </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-#f8a723-500 focus:border-#f8a723-500"
                value={location}
            ...
            <div className="relative">
              ...
              <select
                className="w-full pl-12 pr-4 py-3 border-2 rounded-xl appearance-none focus:ring-2 focus:ring-#f8a723-500 focus:border-#f8a723-500"
                value={category}
            ...
            <button className="bg-#f8a723-600 hover:bg-#f8a723-700 text-white px-8 py-3 rounded-xl font-semibold transition-colors text-lg">
              Search Food
            </button>
          </div>
        </div>
                ...
                <div className="w-3/5 p-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center">
                      <Building2 className="w-5 h-5 text-#f8a723-600 mr-2" />
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {item.tags.map((tag, index) => (
                      <span key={index} className="bg-#f8a723-100 text-#f8a723-700 px-3 py-1 rounded-full text-sm">
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 bg-#f8a723-600 hover:bg-#f8a723-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors">
                      Request Food
                    </button>
