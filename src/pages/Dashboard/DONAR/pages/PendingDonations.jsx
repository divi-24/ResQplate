          ...
          <div className="flex gap-4 w-full sm:w-auto">
            <div className="relative flex-1 sm:flex-none">
              ...
              <input
                ...
                className="w-full sm:w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-#f8a723-500 focus:border-transparent outline-none"
                value={searchQuery}
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between">
                      <div>
                        ...
                        <div className="inline-block px-3 py-1 bg-#f8a723-100 text-#f8a723-800 text-sm font-medium rounded-full mb-4">
                    ...
                    <div className="flex justify-end gap-4">
                      <button onClick={handleViewDetails(donation._id)}
                       className="px-4 py-2 text-#f8a723-600 hover:text-#f8a723-700 font-medium transition-colors duration-200">
                        View Details
                      </button>
                      <button onClick={handleTrackOrder}
                       className="px-4 py-2 bg-#f8a723-600 text-white rounded-lg hover:bg-#f8a723-700 transition-colors duration-200">
                        Track on Map
                      </button>
                    </div>
                  </div>
          ...
          >
            ...
            >
              <div className="flex justify-between items-center">
                <h2 className="text-2xl font-bold text-#f8a723-800">Donation Details</h2>
              ...
              <div className="mt-4">
                ...
                <div className="flex justify-end gap-4">
                  <button className="px-4 py-2 bg-#f8a723-600 text-white rounded-lg hover:bg-#f8a723-700 transition-colors duration-200">
                    Track on Map
                  </button>
                </div>
              </div>
