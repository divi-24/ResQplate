        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-white">
            ...
            <a href="#volunteer-form" 
               className="inline-flex items-center px-6 py-3 bg-#f8a723-600 hover:bg-#f8a723-700 
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-#f8a723-100 rounded-full flex items-center justify-center">
                <Heart className="h-8 w-8 text-#f8a723-600" />
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-#f8a723-100 rounded-full flex items-center justify-center">
                <Calendar className="h-8 w-8 text-#f8a723-600" />
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-#f8a723-100 rounded-full flex items-center justify-center">
                <Users className="h-8 w-8 text-#f8a723-600" />
              </div>
      ...
      <div id="volunteer-form" className="py-24">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  type="text"
                  required
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-#f8a723-500 focus:border-transparent"
                  ...
                  <button
                    ...
                    className={`p-4 border rounded-lg flex flex-col items-center gap-2 transition-colors
                              ${formData.transport === label 
                                ? 'border-#f8a723-500 bg-#f8a723-50 text-#f8a723-700' 
                                : 'border-gray-300 hover:border-#f8a723-500'}`}
                  >
            ...
            <button
              type="submit"
              className="w-full py-3 px-6 bg-#f8a723-600 hover:bg-#f8a723-700 text-white font-semibold rounded-lg transition-colors"
            >
              Submit Application
            </button>
          </form>
            ...
            <div className="divide-y">
              {[1, 2].map((_, i) => (
                <div key={i} className="p-6 flex items-center gap-6">
                  <div className="w-16 h-16 bg-#f8a723-100 rounded-lg flex items-center justify-center">
                    <MapPin className="h-8 w-8 text-#f8a723-600" />
                  </div>
                  ...
                  <button className="px-4 py-2 bg-#f8a723-600 text-white rounded-lg hover:bg-#f8a723-700 transition-colors">
                    View Details
                  </button>
                </div>
              ))}
