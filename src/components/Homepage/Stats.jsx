    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {section.stats.map((stat) => (
                  <div key={stat.label} className="relative bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="absolute bottom-4 right-4">
                      <svg className="h-8 w-8 text-#f8a723-100" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-20 text-center">
          <a href="#" className="inline-flex items-center text-primary hover:text-#f8a723-600 font-medium">
