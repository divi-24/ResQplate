      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-orange-100">Reduce Waste, Feed Lives</p>
              ...
              <ul className="space-y-2">
                {['Home', 'Donate Food', 'Find Food', 'Volunteer'].map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-orange-100 hover:text-primary-dark transition-colors duration-300"
                    >
                      {link}
                    </a>
                  </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                <FaEnvelope className="text-orange-100" />
                <a href="mailto:info@foodsaver.com" className="hover:text-orange-100 transition-colors duration-300">
                  info@foodsaver.com
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <FaPhone className="text-orange-100" />
                <a href="tel:+1234567890" className="hover:text-orange-100 transition-colors duration-300">
                  (123) 456-7890
                </a>
              </li>
              <li className="flex items-center space-x-2">
        ...
        {/* Social Media Links */}
        <div className="mt-8 py-4 border-t border-orange-100/20">
