...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-orange-50 to-orange-100 h-3/4" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button className="px-8 py-4 bg-white text-primary border-2 border-primary rounded-lg font-medium hover:bg-orange-50 transition-colors">
                Become a Volunteer
              </button>
            </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-500 rounded-3xl transform rotate-3 scale-105" />
            <img
